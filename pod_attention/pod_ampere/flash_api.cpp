...
mha_fwd_kvcache(at::Tensor &q,                 // batch_size x seqlen_q x num_heads x head_size
    ...
    // Send our optional params to switch implementations
    params.fused_params = fused_params;

    set_params_alibi(params, alibi_slopes_, batch_size, num_heads);
    // remove support to speed up compilation time.
    assert(params.alibi_slopes_ptr == nullptr);
    assert(!(softcap > 0.0));
