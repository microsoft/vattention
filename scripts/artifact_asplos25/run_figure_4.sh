...
attn_backends="fa_paged"
batch_sizes="1 64 128 192 256 300"
    ...
    for model in $models; do
        ...
        for attn_backend in $attn_backends; do
            for bs in $batch_sizes; do
                ...
                output_dir="$src/logs/figure_4/model_${model}_bs_${bs}/"
                echo -e "\n==================================================================="
                echo "[Figure-4] Running Config ==> Model: $model Batch Size: $bs"
                echo -e "===================================================================\n"
                #: '
                python $benchmark $model_arg \
                    ...
                    --uniform_request_length_generator_prefill_to_decode_ratio 25 \
...
run_experiments
python $src/helpers/plot_figure_4.py