...
print(f"model;cl;cs;kv_len;chunk_id;bs;fa_p;fa_d;fa_serial;fa_streams;" +
...
for model in model_configs:
    ...
    for bs in d_batch_sizes:
        ...
        for chunk_idx, cs in enumerate(curr_chunk_sizes):
            ...
            fi_p, fi_p_latency = fibench.do_flashinfer_prefill_paged(1, cs, cache_seqlen, num_heads, num_kv_heads, head_size, 16)
